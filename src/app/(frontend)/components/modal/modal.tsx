...
const Modal: React.FC<ModalProps> = ({
    ...
    return (
        <>
            <div
                className={`${styles.modal} ${isImageOnly ? styles.imageOnly : ""}`}
            >
                <div
                    aria-modal="true"
