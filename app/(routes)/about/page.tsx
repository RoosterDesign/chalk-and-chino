    ...
    return (
        <>
            ...
            <GalleryCarousel images={images}>
                <SectionHeader title="My Work" intro="Nunc aliquet fermentum sem vitae vulputate. Nullam nec libero tempus, porttitor tellus." linkUrl="/products" linkLabel="View items for sale" centered />
            </GalleryCarousel>
            <Testimonials>
            ...
            <Map>
                <SectionHeader title="Where I'm Based" intro="Nunc aliquet fermentum sem vitae vulputate. Nullam nec libero tempus, porttitor tellus a Nunc aliquet." linkUrl="/contact" linkLabel="Get in touch" centered />
            </Map>
            <FeaturedProducts>
